...
public class JWTTokenAutenticacaoService {
	...
	private static final String SECRET = "SenhaExtremanenteSecreta";
	...
	public void addAuthentication(HttpServletResponse response, String username) throws IOException {
		...
		ApplicationContextLoad.getApplicationContext().getBean(UsuarioRepository.class).atualizaTokenUser(JWT,
				username);
		// Liberando resposta para portas diferentes que usam a API, ou caso clientes
		// web
		liberacaoCors(response);
		// Esreve TOKEN como resposta no corpo do HTTP
